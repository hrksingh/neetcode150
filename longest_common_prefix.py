...
print(
    Solution().longestCommonPrefix(["flow", "flower", "flog", "flight"])
)  # this example for prefix[i] != word[i]
print(
    Solution().longestCommonPrefix(["flow", "flower", "flog", "fl"])
)  # this example for i == len(word)
